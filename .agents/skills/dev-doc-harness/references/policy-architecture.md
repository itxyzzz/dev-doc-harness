...
| `module:quality` | `references/durable-planning-quality.md` | Normative policy | Baseline plain-language and durable spec and plan quality, including additional phase-plan quality, Specification Commitments, Verification Criteria, Plan Tasks, Plan Checks, asymmetric plan coverage, static conformance semantics, and handoff preservation. |
