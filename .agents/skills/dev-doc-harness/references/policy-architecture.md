...
| `module:quality` | `references/durable-planning-quality.md` | Normative policy | Baseline plain-language and durable spec and plan quality, including additional phase-plan quality, Specification Commitments, Verification Criteria, Plan Checks, asymmetric plan coverage, evidence-to-conformance status, and handoff preservation. |
